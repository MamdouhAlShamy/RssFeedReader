    ...
    QStackedWidget(parent)
{
        ...
        m_speed=500;
        m_animationtype = QEasingCurve::InBounce;  //check out the QEasingCurve documentation for different styles
        m_now=0;
        m_next=0;
        m_wrap=false;
        m_pnow=QPoint(0,0);
...
void SlidingStackedWidget::slideHome()
{
    slideInIdx(0,BOTTOM2TOP);
}
